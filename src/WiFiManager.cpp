...
String html_last ="</select> </td> </tr> <tr> <td> <label>Password: </label> </td> <td> <input maxlength=\"30\" name=\"password\"> </td> </tr> <tr> <td colspan=\"2\" style=\"text-align:center;\">Please insert your Nightscout name here. if your address is https://NIGHTSTANDER.herokuapp.com then your Nightscout name is NIGHTSTANDER.herokuapp.com </td></tr> <tr> <td> <label>Nightscout: </label> </td> <td> <input maxlength=\"100\" name=\"nightscout\"> </td> </tr><tr><td colspan=\"2\" style=\"text-align:center;\">You need to hash your api-key before you type it in here. Turn off wifi and visit this link <a href=\"http://www.sha1-online.com\" target=\"_blank\" style=\"color:yellow\">http://www.sha1-online.com/</a>. Type your api-key in the box and copy the results. Then turn wifi back on and make sure you are connected to Nightstander WiFi and paste the result here.</td></tr> <tr> <td> <label>Api-Key: </label> </td> <td> <input maxlength=\"100\" name=\"apikey\"> </td> </tr> <tr><td class=\"save\" colspan=\"2\"> <input type=\"submit\" value=\"Save\" class=\"button\"> </td> </tr> </table> </form> </body> </html>";
